...
export const BABY_LOG_COLUMNS =
  "id, log_type, logged_at, logged_by, feeding_type, amount_ml, breast_left_count, breast_right_count, breast_left_sec, breast_right_sec, breast_start_side, diaper_type, poop_amount, temperature, weight_g, height_cm, duration_min, duration_sec, memo, created_at"
